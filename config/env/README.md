...
The backend and Vite select the file through `AI_WORKER_PROFILE=local|production`. The launch scripts set this value automatically. Direct commands default to `local` unless the variable is already set.
